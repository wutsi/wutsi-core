...
open class Http(
    ...
    @Throws(RestClientException::class)
    fun <T> post(url: String, request: Any?, responseType: Class<T>?, headers:Map<String, String>? = null): ResponseEntity<T> {
    ...
    private fun <T> exchange(method: HttpMethod, url: String, request: Any?, responseType: Class<T>?, head:Map<String, String>? = null): ResponseEntity<T> {
